...
**Secondary trial objectives** were to evaluate the efficacy of additional oxaliplatin to the standard regimen on: - overall survival which is defined as time from randomisation to death from any cause - incidence of local and distant recurrences which is defined as the time between randomization and occurrence of any locoregional and distant recurrence, respectively, irrespective of whether this was a first event or not.
