...
In this page, we follow the statistical analysis plan (SAP) we prepared to reproduce all the tables and figures reported in in Rödel et al. (2015), including:
...
Due to having missing data within variables in the given data, we could not reproduce the cumulative locoregional recurrence.
