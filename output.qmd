...
results_ypt <-data.frame()
results_ypt <- rbind(results_ypt, calculate_hr(CAOsurv, "pT == 'ypT1'", "ypT1"))

CAOsurv %>%
  filter(pT=='ypT1') %>%
  mutate(dfs_status = as.numeric(CAOsurv$DFSevent),
         treatment = ifelse(CAOsurv$randarm == "5-FU + Oxaliplatin", 1, 0)) %>%
