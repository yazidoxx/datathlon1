...
Secondary trial objectives are to evaluate the efficacy of additional oxaliplatin to the standard regimen on overall survival and incidence of local and distant recurrences.
...
Note: Due to having missing data within variables in the provided data, we could not reproduce the cumulative locoregional recurrence (Figure 3, Panel A) and there are discrepancies in Table2.
...
**The table structure matches the original publication and we fully reproduced Table 1 exactly as reported in Rödel et al. (2015)**
