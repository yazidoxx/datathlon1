...
**Our reproduced @table1 structure matches the original publication and we could reproduce it exactly as Table 1 presented in Rödel et al. (2015).**
...
df.fig3 <- CAOsurv %>%
  mutate(LRplot = case_when(LRtype == "Tod" ~ 0,
         ...
         DRplot = case_when(DRtype == "Tod" ~ 0, # who didn't have distant recurrence but died
                            grepl("censored", DRtype) ~ 0,
                            TRUE ~ 1),
         deathplot = case_when(DRtype == "Tod" ~ 1, # who didn't have distant recurrence but died
                            grepl("censored", DRtype) ~ 0,
                            TRUE ~ 0),
         drtime = DRtime/365,
         lrtime = LRtime/365)
...
```{r}
#| label: github-qr
#| fig-cap: QR Code linking to GitHub repository
#| fig-align: center
...
**GitHub Repository**: https://github.com/yazidoxx/datathlon1
